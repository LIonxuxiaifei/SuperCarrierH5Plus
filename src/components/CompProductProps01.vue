<template>
  <el-form ref="form" label-width="80px">
    <el-form-item v-if="comp.props.bgColor.available" label="背景颜色">
      <el-color-picker v-model="comp.props.bgColor.val" ></el-color-picker>
    </el-form-item>
    ...
    <el-form-item v-if="comp.props.linkType.available&&comp.props.linkType.val===sup8._def.linkType.outerPage.value" label="外部地址" >
      <el-input v-model="comp.props.linkVal.val" placeholder="请输入地址" :disabled="sup8.role.permissionLevel<comp.props.linkType.level"></el-input>
    </el-form-item>
    ...
    <el-form-item v-if="comp.props.linkType.available&&comp.props.linkType.val===sup8._def.linkType.otherTemplate.value" label="模板编号" >
      <el-input v-model="comp.props.linkVal.val" placeholder="请输入模板编号" :disabled="sup8.role.permissionLevel<comp.props.linkType.level"></el-input>
    </el-form-item>
