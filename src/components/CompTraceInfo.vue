...
export default {
  ...
  created: function() {
    ...
    switch (that.sup8.env) {
      ...
      case that.sup8._def.env.design:
        that.content =
          '<div style=""><h2>溯源信息-假数据</h2><hr><p> 溯源信息</p><img style="width: 100%" src="http://image.supercarrier8.com/antifaketemplae/%E4%BC%81%E4%B8%9A%E4%BB%8B%E7%BB%8D%E5%9B%BE%E7%89%87.png" alt=""></div></div>';
        break;
      case that.sup8._def.env.run:
        
        apiHelper.getTraceInfo(
          that.sup8.codeInfo.EnterpriseNo,
          that.sup8.codeInfo.SkuLogisticCode,
  ...
  mounted: function() {
    console.log("CompTraceInfo:mounted:this.comp", this.comp);
  }
};
</script>
